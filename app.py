...
# === Load model ===
model = joblib.load(r'C:\Users\sai\Desktop\My Project\forecasting_ev_model.pkl')
...
# Image
st.image(r"C:\Users\sai\Desktop\My Project\ev-car-factory.jpg", use_container_width=True)
...
@st.cache_data
def load_data():
    df = pd.read_csv(r"C:\Users\sai\Desktop\My Project\preprocessed_ev_data.csv")
